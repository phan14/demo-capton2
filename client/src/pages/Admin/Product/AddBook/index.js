  ...
  const formik = useFormik({
    ...
    onSubmit: async () => {
      ...
      try {
        ...
        setLoading(true)
        const resCloudinary = await axios.post("https://api.cloudinary.com/v1_1/dtfsciqga/image/upload", formData)
    ...
    <Row>
      <Col xl={12}>
        <div className="admin-content-wrapper">
          <div className="admin-content-header">Add New Product</div>
          <div className="admin-content-body">
            <form onSubmit={formik.handleSubmit}>
              <Row>
                <Col xl={3}>
                  <div className="form-group">
                    <label className={styles.formLabel}>ID Product</label>
                    <input
                      type="text"
                      name="bookId"
                      className={`form-control ${formik.errors.bookId && formik.touched.bookId
                        ? "is-invalid"
              ...
              <Row>
                <Col xl={3}>
                  <div className="form-group">
                    <label className={styles.formLabel}>Picture</label>
                    <input
                      type="file"
                      name="image"
