    ...
    register: async (req, res) => {
        try {
            ...
            const resultSendMail = await transporter.sendMail({
                ...
                to: email,
                subject: `[SCIS] Chúc mừng bạn đăng ký thành công!`,
                html: ` <h3>Xin chào ${fullName},</h3>
                        <h3>Bạn vừa tiến hành đăng ký tài khoản tại SCIS!</h3>
                        <p>Chúc mừng bạn trở thành thành viên SCIS.</p>
                        <p>Username : ${email}</p>
    ...
    handleForgotPassword: async (req, res) => {
        try {
            ...
            const resultSendMail = await transporter.sendMail({
                from: '"SCIS" <project.php.nhncomputer@gmail.com>',
                to: email,
                subject: `[SCIS] Hãy đặt lại mật khẩu tài khoản của bạn`,
                html: ` <h2>Xin chào bạn ${user.fullName},</h2>
                        <p>Chúng tôi biết rằng bạn đã mất mật khẩu SCIS của mình.</p>
                        <p>
